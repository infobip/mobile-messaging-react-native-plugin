...
Pod::Spec.new do |s|
  ...
  s.dependency "MobileMessaging/Core", "12.3.6"
  s.dependency "MobileMessaging/Geofencing", "12.3.6"
  s.dependency "MobileMessaging/InAppChat", "12.3.6"
  if defined?($WebRTCUIEnabled)
    s.dependency "MobileMessaging/WebRTCUI", "12.3.6"
  end
end
